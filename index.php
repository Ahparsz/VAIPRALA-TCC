...
<!--AQUI É O CARROSSEL-->
      <div class="carousel slide" id="carrosel" data-ride="carousel">
          ...
          <li data-target='#carrosel' data-target-to="5"></li>
            ...
            <p class="text-capitalize font-weight-bold text-dark">Seu site de viagens preferido!</p>
					...
					<div class="carousel-item">
						...
						<div class="carousel-caption bg-white">
            <h3 class="text-capitalize text-dark">Brasília:</h3>
            <p class="text-capitalize text-dark">Conheça a capital do país na região Centro Oeste</p>
            <a href='destino.php' type="button" id='buttonca' class='text-dark'>Saiba Mais</a>
						</div>
					</div>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption bg-white">
            <h3 class="text-capitalize text-dark">São Paulo:</h3>
            <p class="text-capitalize text-dark">Conheça a "Selva de Pedra" da região Sudeste.</p>
            <a href='destino.php' type="button" id='buttonca' class='text-dark'>Saiba Mais</a>
            </div>
          </div>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption bg-white">
            <h3 class="text-capitalize text-dark">Manaus:</h3>
            <p class="text-capitalize text-dark">Conheça a floresta mais encantadora do mundo: Amazônia</p>
            <a href='destino.php' type="button" id='buttonca' class='text-dark'>Saiba Mais</a>
            </div>
          </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                      <h4 class="modal-title">Como fazer suas malas</h4>
    ...
    <div class="col-sm-4">
      <div class="card"> 
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-outline-info btn-block" data-toggle="modal" data-target="#segundoModal" id='botao-card'>Ler</button>
          <div class="modal fade" id="segundoModal">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                      <h4 class="modal-title">Antes de viajar</h4>
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
    ...
    <div class="col-sm-4">
      <div class="card"> 
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-outline-info btn-block" data-toggle="modal" data-target="#terceiroModal" id='botao-card'>Ler</button>
          <div class="modal fade" id="terceiroModal">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                      <h4 class="modal-title">O que fazer no destino</h4>
                      <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
                    <div class="modal-body">
