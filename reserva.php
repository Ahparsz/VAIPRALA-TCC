...
if(isset($_POST['clima'])) {
    ...
    $clima = " AND cidadeclima.id_clima=".$_POST['clima'];
    $ambiente = "";
    $tipo = "";
...
//AQUI QUANDO APERTAR NO TIPO, MUDA LÁ
if(isset($_POST['tipo'])) {
    $cidades='';

    $uau="SELECT * FROM cidade, cidadetipo, tipo WHERE cidade.cd_cidade = cidadetipo.id_cidade AND tipo.cd_tipo = cidadetipo.id_tipo AND cidade.id_estado =".$_SESSION['estado'];
    $clima = "";
    $ambiente = "";
    $tipo = " AND cidadetipo.id_tipo=".$_POST['tipo'];
